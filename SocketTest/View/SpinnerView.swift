...
class SpinnerView: UIView {
    ...
    var Style : SpinnerStyle = .Light
    
    var hidesWhenStopped : Bool = false
    
    var outerFillColor : UIColor = UIColor.clear
    var outerStrokeColor : UIColor = UIColor.clear
    var outerLineWidth : CGFloat = 5.0
    var outerEndStroke : CGFloat = 0.8
    var outerAnimationDuration : CGFloat = 2.0
    
    var enableInnerLayer : Bool = true
    
    var innerFillColor : UIColor  = UIColor.clear
    var innerStrokeColor : UIColor = UIColor.gray
    var innerLineWidth : CGFloat = 5.0
    var innerEndStroke : CGFloat = 0.8
    var innerAnimationDuration : CGFloat = 1.6
    
    var labelText : String  = ""
    var labelFont : String  = "Helvetica"
    var labelTextColor : UIColor  = UIColor.black
    var labelFontSize : CGFloat = 11.0
